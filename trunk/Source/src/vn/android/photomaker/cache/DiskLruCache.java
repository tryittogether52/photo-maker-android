...
public class DiskLruCache {
	...
	private final int maxCacheItemSize = 1000; // 1000 item default
	private long maxCacheByteSize = 1024 * 1024 * 2; // 2MB default
	...
	/**
	 * Remove key if a specific key exist in the cache.
	 * 
	 * @param {key} The unique identifier for the bitmap
	 */
